...
hi Comment  term=NONE	cterm=NONE	ctermfg=237	ctermbg=NONE	gui=NONE	guifg=#3a3a3a	guibg=NONE

"hi FoldColumn	  term=NONE	cterm=NONE	ctermfg=0	ctermbg=240	gui=NONE	guifg=#C0C0C0	guibg=#121212
hi Folded		      term=NONE	cterm=NONE	ctermfg=237	ctermbg=NONE	gui=NONE	guifg=#3a3a3a	guibg=NONE
...
hi SignColumn		  term=NONE	cterm=NONE	ctermfg=236	ctermbg=233	gui=NONE	guifg=#3a3a3a	guibg=#121212
...
hi CursorLineNr   term=NONE	cterm=NONE	ctermfg=7	ctermbg=236	gui=NONE	guifg=#c0c0c0	guibg=#3a3a3a
hi CursorLine		  term=NONE	cterm=NONE	ctermfg=7	ctermbg=236	gui=NONE	guifg=#c0c0c0	guibg=#3a3a3a
"hi Directory		  term=NONE	cterm=NONE	ctermfg=69	ctermbg=NONE	gui=NONE	guifg=#5F87FF	guibg=NONE
hi ErrorMsg		    term=NONE	cterm=NONE	ctermfg=7	ctermbg=52	gui=NONE	guifg=NONE	guibg=#af0000
hi Error		      term=NONE	cterm=NONE	ctermfg=7	ctermbg=52	gui=NONE	guifg=NONE	guibg=#af0000
...
hi Todo		        term=NONE	cterm=NONE	ctermfg=129	ctermbg=NONE	gui=NONE	guifg=#af00ff   guibg=NONE
...
hi ColorColumn    term=NONE	cterm=NONE	ctermfg=233	ctermbg=242	gui=NONE	guifg=#121212	guibg=#3a3a3a
...
hi MatchParen		  term=NONE	cterm=NONE	ctermfg=7	ctermbg=236	gui=NONE	guifg=#c0c0c0	guibg=#3a3a3a
hi Visual		      term=NONE	cterm=NONE	ctermfg=7	ctermbg=236	gui=NONE	guifg=#c0c0c0	guibg=#3a3a3a
hi WildMenu		    term=NONE	cterm=NONE	ctermfg=7	ctermbg=236	gui=NONE	guifg=#c0c0c0	guibg=#3a3a3a
